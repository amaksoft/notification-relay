...
// Seed color for the static (pre-Android-12 / dynamic-color-disabled)
// fallback scheme. Real tonal palettes are generated below rather than
// hand-picked, per MD3 guidance (never hardcode arbitrary role colors).
val SeedPrimary = Color(0xFF3F51B5)

val md_theme_light_primary = Color(0xFF39498E)
...
val md_theme_dark_primary = Color(0xFFBFC3FF)
val md_theme_dark_onPrimary = Color(0xFF06196A)
val md_theme_dark_primaryContainer = Color(0xFF1F3082)
